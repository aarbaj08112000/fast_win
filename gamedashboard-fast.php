...
<div class="vcard">
  <div class="appContent3 text-white">
    <div class="row">
      <div class="col-12">
        <div class="col-12 mb-1" style="font-size:18px;">Available balance: ₹ <span id="balance"><?php echo number_format(wallet($con,'amount',$userid), 2); ?></span><a  data-toggle="modal" href="#rule" data-backdrop="static" data-keyboard="false" class="btn btn-sm btn-light">Read Rule</a></div>
        <div class="col-12">
          <div>  <a href="recharge.php" class="btn btn-sm btn-success m-0">Recharge</a> <a href="withdrawal.php" class="btn btn-sm btn-success m-0">Withdraw</a> <a href="javascript:void(0);" onClick="reloadbtn(<?php echo $userid;?>);" class="reaload text-white pull-right mt-1" onclick="getResultbyCategory(parity,parity)"> <i class="icon ion-md-refresh"></i></a> </div>
        </div>
      </div>
    </div>
  </div>
...
<a class="nav-link active" id="home-tab3" data-toggle="tab" href="#parity" role="tab" onClick="tabname('parity');getResultbyCategory('parity','parity');">Parity</a> 
     ...
     <div cla="container-fluid  ">
      ...
      <div class="divsize2">
      <button type="button" class="btn btn-sm btn-info gbutton none" onClick="betbutton('#18FFFF','button','0');">0</button>
      </div>
      <div class="divsize2">
      <button type="numbutton" class="btn btn-sm btn-info gbutton none" onClick="betbutton('#18FFFF','button','1');">1</button>
      </div>
      
      <div class="divsize2">
      <button type="button" class="btn btn-sm btn-info gbutton none" onClick="betbutton('#18FFFF','button','2');">2</button>
      </div>
      
      <div class="divsize2">
      <button type="button" class="btn btn-sm btn-info gbutton none" onClick="betbutton('#18FFFF','button','3');">3</button>
      </div>
      
      <div class="divsize2">
      <button type="button" class="btn btn-sm btn-info gbutton none" onClick="betbutton('#18FFFF','button','4');">4</button>
      </div>
      ...
      <div class="divsize2">
      <button type="button" class="btn btn-sm btn-info gbutton none" onClick="betbutton('#18FFFF','button','5');">5 </button>
      </div>
      
      <div class="divsize2">
      <button type="button" class="btn btn-sm btn-info gbutton none" onClick="betbutton('#18FFFF','button','6');"> 6</button>
      </div>
      
      <div class="divsize2">
      <button type="button" class="btn btn-sm btn-info gbutton none" onClick="betbutton('#18FFFF','button','7');">7 </button>
      </div>
      <div class="divsize2">
      <button type="button" class="btn btn-sm btn-info gbutton none" onClick="betbutton('#18FFFF','button','8');"> 8</button>
      </div>
      <div class="divsize2">
      <button type="button" class="btn btn-sm btn-info gbutton none" onClick="betbutton('#18FFFF','button','9');">9 </button>
      </div>
      </div>
...
if(distance==30 || distance==27 || distance==24 || distance==21 || distance==18){
generateGameid();
getResultbyCategory('parity','parity');
...
var futureid=$('#futureid').val();
    ...
    url: "periodid-generationfast.php",
...
$.ajax({
    ...
    url: "getResultbyCategoryfast.php",
    success: function (html) {
