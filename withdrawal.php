...
<p class="text-center m-2" Style="font-size:11px; color: red;">Minimmum Withdrawal is Now 500 Rs</p>
    ...
    <form action="#" id="paymentForm" method="post" class="card-body" autocomplete="off">
      ...
      <div class="btn-group btn-group-toggle mt-1" data-toggle="buttons">
                        ...
                        <label class="btn btn-outline-primary ml-1">
                            <input type="radio" name="optionsname" id="option3" value="upi" onChange="paytype(<?php echo $userid?>,'upi')">
                            <i class="icon ion-md-checkmark"></i>&nbsp;
                            UPI ID
                        </label>
                    </div>
                 <div class="text-right mt-1">
    <a href="manage_bankcard.php" class="text-danger"><i class="fa fa-plus"></i> Add Bank/UPI</a>
    </div>   
