...
{?>
    ...
    <p> <i class="icon ion-md-trophy"></i> <div class="title">Sapre Record</div> </p>
        ...
        <tbody>
        <?php
 $saprerecordQuery=mysqli_query($con,"select * from `tbl_result1` where `tabtype`='sapre' order by id desc limit 480");
 ...
 <div class="point" style="background:#1DCC70;"></div>&nbsp;
    ...
    <?php
  $userResultQuery=mysqli_query($con,"select *,(select `result` from `tbl_result1` where `periodid`=`tbl_userresult1`.`periodid` and `tabtype`=`tbl_userresult1`.`tab`)as resultnumber,(select `color` from `tbl_result1` where `periodid`=`tbl_userresult1`.`periodid` and `tabtype`=`tbl_userresult1`.`tab`)as resultcolor from `tbl_userresult1` where `userid`='".$userid."' and `tab`='sapre' and date(`createdate`)='".$today."' order by id desc limit 480");
  while($userResult=mysqli_fetch_array($userResultQuery)){
	  $post_date = $userResult['createdate'];
 $post_date2 = strtotime($post_date);
 $convert=date('Y-m-d H:i',$post_date2);
...
<div class="containerrecord text-center">
    ...
    <p> <i class="icon ion-md-trophy"></i> <div class="title">Bcone Record</div> </p>
        ...
        <tbody>
        <?php
 $bconerecordQuery=mysqli_query($con,"select * from `tbl_result1` where `tabtype`='bcone' order by id desc limit 480");
 ...
 <div class="point" style="background:#1DCC70;"></div>&nbsp;
    ...
    <?php
  $userResultQuery=mysqli_query($con,"select *,(select `result` from `tbl_result1` where `periodid`=`tbl_userresult1`.`periodid` and `tabtype`=`tbl_userresult1`.`tab`)as resultnumber,(select `color` from `tbl_result1` where `periodid`=`tbl_userresult1`.`periodid` and `tabtype`=`tbl_userresult1`.`tab`)as resultcolor from `tbl_userresult1` where `userid`='".$userid."' and `tab`='bcone' and date(`createdate`)='".$today."' order by id desc limit 480");
  while($userResult=mysqli_fetch_array($userResultQuery)){
	  $post_date = $userResult['createdate'];
 $post_date2 = strtotime($post_date);
 $convert=date('Y-m-d H:i',$post_date2);
...
<?php
 ...
 ?>
    ...
    <p> <i class="icon ion-md-trophy"></i> <div class="title">Emerd Record</div> </p>
        ...
        <tbody>
        <?php
 $emerdrecordQuery=mysqli_query($con,"select * from `tbl_result1` where `tabtype`='emerd' order by id desc limit 480");
 ...
 <div class="point" style="background:#1DCC70;"></div>&nbsp;
    ...
    <?php
  $userResultQuery=mysqli_query($con,"select *,(select `result` from `tbl_result1` where `periodid`=`tbl_userresult1`.`periodid` and `tabtype`=`tbl_userresult1`.`tab`)as resultnumber,(select `color` from `tbl_result1` where `periodid`=`tbl_userresult1`.`periodid` and `tabtype`=`tbl_userresult1`.`tab`)as resultcolor from `tbl_userresult1` where `userid`='".$userid."' and `tab`='emerd' and date(`createdate`)='".$today."' order by id desc limit 480");
  while($userResult=mysqli_fetch_array($userResultQuery)){
	  $post_date = $userResult['createdate'];
 $post_date2 = strtotime($post_date);
 $convert=date('Y-m-d H:i',$post_date2);
