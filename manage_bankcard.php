...
while($bankResult=mysqli_fetch_array($selectBankQuery)){
        ...
        <div class="card mb-3">
                <div class="card-body">
                    ...
                    <p><?php echo 'UPI ID:'.$bankResult['upid'];?></p>
                    ...
                    <p><?php echo $bankResult['email'];?> <a href="javascript:void(0);" class="text-danger pull-right" onClick="delete_row(<?php echo $bankResult['id'];?>)"><i class="fa fa-trash"></i></a></p>
                     <p> <?php if($bankResult['status']==0) {?>
                     <a href="activatebank.php?id=<?php echo $bankResult['id'];?>&userid=<?php echo $userid;?>" class="text-right pull-right"><i class="fa fa-check"></i>Activate</a>
                     <?php }else{ echo "Active"; }?></p>
                </div>
            </div>
