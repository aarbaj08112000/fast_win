  ...
  <div class="appContent1 mb-2">
    ...
    <div class="row ">
      ...
      <div class="inner-addon left-addon">
        ...
        <input type="hidden" name="email" id="email" value="test@gmail.com" class="form-control" placeholder="Email-id">
      </div>
      <div class="inner-addon left-addon">
      ...
      <div class="inner-addon left-addon">
        ...
        <input type="hidden" name="rcode" id="rcode" class="form-control" placeholder="Recommendation Code" value="531493731">
      </div>
