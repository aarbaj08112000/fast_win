...
<?php include ("include/header.inc.php");?>
 ...
 <?php include ("include/navigation.inc.php");?> 
  ...
  while($row=mysqli_fetch_array($Query)){$i++;?>  
	  ...
	  if($row['is_agent']==0){
	  ?>
       <a href="makeagent.php?id=<?php echo $row['id'];  ?> "  class="update-person" style="color:#090; font-size:16px;" data-toggle="tooltip" title="Make Agent"><i class="fa fa-check-square-o"></i></a>
       <?php } else{?>
       Agent
       <?php } ?>
      </td>
