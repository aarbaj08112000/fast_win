<?php
// $con = @mysqli_connect('localhost', 'fastwin', 'FastWin@123!','fastwin');
$con = @mysqli_connect('localhost', 'root', 'Root@12345678','fastwin');
...
function wallet($a, $field, $id)
{
    ...
    if ($walletResult === null) {
        ...
        // echo "Error: No result found for user ID " . $id;
        echo 0.00;
        return null; // or another appropriate value
    }
