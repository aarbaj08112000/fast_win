...
$sql= mysqli_query($con,"INSERT INTO `tbl_betting1` (`userid`, `periodid`, `type`,`value`,`amount`,`tab`,`acceptrule`) VALUES ('".$userid."','".$inputgameid."','".$type."','".$value."','".$finalamount."','".$tab."','".$presalerule."')");

//=====================transaction==================================================
$sql= mysqli_query($con,"INSERT INTO `tbl_order1`(`userid`,`transactionid`,`amount`,`status`) VALUES ('".$userid."','".$inputgameid."','".$finalamount."','1')");
